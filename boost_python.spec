#
# Victor Eijkhout 2023
# formerly:
# Si Liu
# 2017-11-01
#
# ./build_rpm.sh --gcc=122 -l boost_python.spec
...
%changelog
* Wed Aug 26 2023 eijkhout <eijkhout@tacc.utexas.edu>
- release 2: trying out 1.83, also now in home1
