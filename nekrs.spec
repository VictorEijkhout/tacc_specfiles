Summary: Nekrs install

# Give the package a base name
%define pkg_base_name nekrs
%define MODULE_VAR    NEKRS
...
Release: 3%{?dist}
License: GPL
Vendor: https://github.com/nekrs-space/nekrs
#Source1: nekrs-setup.sh
...
%package %{PACKAGE}
Summary: Nekrs local binary install
...
%changelog
* Sun Feb 01 2026 eijkhout <eijkhout@tacc.utexas.edu>
