Summary: Octopus install

# ./build_rpm.sh -i231 -j21_9 -l octopus-new

# Give the package a base name
%define pkg_base_name octopus
...
%package %{PACKAGE}
Summary: Octopus local binary install
...
## where do we need this? module load git
