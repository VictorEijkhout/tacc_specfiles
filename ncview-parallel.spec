...
%define pkg_base_name ncview-parallel
%define MODULE_VAR    NCVIEWPARALLEL
...
# not setup -n %{pkg_base_name}-%{pkg_version}
%setup -n ncview-%{pkg_version}
...
##
## loop over sequential parallel
##
for netcdf in parallel-netcdf ; do
...
- release 2: parallel netcdf added
