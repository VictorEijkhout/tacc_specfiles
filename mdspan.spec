...
# Victor Eijkhout
#
# INCOMPATIBLE ./build_rpm.sh -i191 mdspan.spec
# ./build_rpm.sh -i231 mdspan-new.spec
# ./build_rpm.sh -g91 mdspan-new.spec
# ./build_rpm.sh -g132 mdspan-new.spec
#
Summary: C++20 mdspan from Kokos

# Give the package a base name
%define pkg_base_name mdspan
